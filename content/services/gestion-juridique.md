...
La prise de RDV physique ou téléphonique, l’accueil du client (toujours avec le sourire), contact avec les juridictions et autres, prise de notes en sténographie, dictées numériques avec retranscription (courrier, courriel, assignation, conclusion, requêtes, compte-rendu, contrat).

Retranscription avec le logiciel EXPRESS SCRIBE.
